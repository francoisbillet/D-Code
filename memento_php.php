	...
	<body>
		<div id="bloc_page">
			...
			<section>
				...
				<p> URL rewriting pour avoir une URL "plus jolie". </p>

				<p> <strong>namespaces</strong> pour autoriser que 2 classes aient le même nom (gros projets). <br />
					<strong>use</strong> pour éviter la répétition du namespace en préfixe </p>

				<p> Documenter au format PHPDoc pour pouvoir générer automatiquement une documentation HTML </p>
